...
steam.prototype.validate = function (obj, method) {
  ...
  switch (method) {
    ...
    case 'getOwnedGames':
      ...
      if (!obj.include_appinfo != 0 && !obj.include_appinfo != 1) {
        error = 'getOwnedGames include_appinfo only accepts 0 or 1'
      }
      break;
    case 'getAssetPrices':
...
steam.prototype.makeRequest = function (obj) {
  ...
  if (path == "/IPlayerService/GetOwnedGames/v0001/?") {
    path += qs.stringify(obj) + '&include_appinfo=' + obj.include_appinfo;
  } else {
    // Generate the path
